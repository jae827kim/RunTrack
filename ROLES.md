...
| 주차 | 작업 |
|------|------|
| 1주 (9/17-9/23) | DB 설계 (ERD), 테이블 구조 정의 |
| 2주 (9/24-9/30) | ORM 모델 작성 (User, Shoe, RunningRecord) |
| 3주 (10/1-10/7) | Pydantic 검증 스키마 작성 |
| 4주 (10/8-10/14) | 통합 테스트 기본 구조 작성 |
| 5주 (10/15-10/21) | 통합 테스트 검증 |
| 6-9주 (10/22-11/18) | 전체 시스템 통합점검, 버그 수정 |
| 10주 (11/19-11/25) | 최종 발표 준비 |
